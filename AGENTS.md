...
- Current npm/native release targets: `aarch64-apple-darwin`, `x86_64-apple-darwin`, `aarch64-unknown-linux-gnu`, `x86_64-unknown-linux-gnu`, `x86_64-unknown-linux-musl`, `x86_64-pc-windows-msvc`.
...
- Keep Linux release targets aligned with dist config. Current native targets are `aarch64-unknown-linux-gnu`, `x86_64-unknown-linux-gnu`, and `x86_64-unknown-linux-musl`.
